...
export default function DocsPage() {
  return (
    <article className="max-w-3xl">
      ...
      <p className="mt-3 text-lg text-muted-foreground">
        A JSON format for software cheatsheets, designed around how people
      ...
      <Card className="mt-6 border-border/50 bg-card/60">
        <CardContent className="p-4">
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li>
              <a href="#cli-usage" className="text-primary hover:underline">
                CLI Usage
              </a>
            </li>
            <li>
      ...
      <Section id="what-is-chson" title="What is ChSON?">
        <p>
          ChSON (Cheatsheet JSON) is a small JSON format for writing software
          cheatsheets in a consistent, tool-friendly way. The goal is simple:
          write a cheatsheet once, then consume it anywhere—searchable websites,
          printable pages, study decks, or personal knowledge bases.
        </p>
        <p>
          The v2 format is designed around{' '}
          <strong className="text-foreground">cognitive retrieval theory</strong>: how
          people actually scan and look up information. When you use a
          cheatsheet, you typically scan for something you recognize (a command,
          shortcut, or keyword) to find the information you need.
        </p>
      </Section>

      <Section id="core-concepts" title="Core Concepts">
        <SubSection title="Anchor and Content">
          <p>Every cheatsheet entry has two key parts:</p>
          <ul className="ml-2 list-inside list-disc space-y-1">
            <li>
              <strong className="text-foreground">anchor</strong> — The retrieval cue.
              What you scan for. (command, shortcut, keyword)
            </li>
            <li>
              <strong className="text-foreground">content</strong> — The information you
              need when you find it. (description, action, result)
            </li>
          </ul>
          <p>
  ...
  "content": "Show staged, unstaged, and untracked files."
        ...
        <SubSection title="Optional Labels">
          <p>
            Sometimes the anchor is cryptic—a keyboard shortcut, obscure
            command, or symbol. The optional{' '}
  ...
  "label": "Go to start"
          ...
          <p>
            Labels are useful for vim commands, keyboard shortcuts, or any
            anchor that isn&apos;t immediately self-explanatory.
          </p>
        </SubSection>

        <SubSection title="Sections">
          <p>
            Entries are organized into sections, each with a title and optional
      ...
      <Section id="advanced-features" title="Advanced Features">
        <SubSection title="Retrieval Direction">
          <p>
            ...
            field describes how users typically scan the cheatsheet:
          </p>
          <ul className="ml-2 list-inside list-disc space-y-1">
            <li>
              <strong className="text-foreground">&quot;mechanism-to-meaning&quot;</strong>{' '}
              — Users scan by command/syntax to find what it does. Most
              cheatsheets work this way.{' '}
              <em>
                &quot;What does{' '}
            ...
            <li>
              <strong className="text-foreground">&quot;intent-to-mechanism&quot;</strong>{' '}
              — Users scan by goal to find how to do it. Reverse lookups.{' '}
  ...
  "retrievalDirection": "mechanism-to-meaning"
        ...
        <SubSection title="Custom Column Labels">
          <p>
            By default, renderers display &quot;Anchor&quot; and &quot;Content&quot; as column
            headers. You can customize these with{' '}
            <Badge variant="secondary" className="font-mono text-xs">
              anchorLabel
            </Badge>{' '}
            and{' '}
  ...
  "contentLabel": "Description"
          ...
          <p>
            This makes the rendered output more intuitive for the specific type
            of cheatsheet.
          </p>
        </SubSection>
  ...
  "sections": [
    ...
    },
    {
      ...
      <Section id="cli-usage" title="CLI Usage">
        <p>
          The ChSON CLI validates files against the schema and renders them to
          Markdown.
        </p>
      ...
      <Section id="best-practices" title="Best Practices">
        <SubSection title="When to use labels">
          <ul className="ml-2 list-inside list-disc space-y-1">
            ...
            <li>
              Vim/editor commands (
              <code className="rounded bg-muted px-1 font-mono">gg</code>,{' '}
              <code className="rounded bg-muted px-1 font-mono">dd</code>)
            </li>
            <li>
            ...
            <li>
              Any anchor that isn&apos;t immediately clear to your target audience
            </li>
          </ul>
        </SubSection>
        ...
        <SubSection title="Choosing retrieval direction">
          <ul className="ml-2 list-inside list-disc space-y-1">
            <li>
              Use <strong className="text-foreground">&quot;mechanism-to-meaning&quot;</strong>{' '}
              for most cheatsheets (command references, shortcuts)
            </li>
            <li>
              Use <strong className="text-foreground">&quot;intent-to-mechanism&quot;</strong>{' '}
              when users will search by goal (&quot;how do I...&quot;)
            </li>
