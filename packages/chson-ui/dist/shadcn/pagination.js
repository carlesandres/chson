...
const PaginationPrevious = ({ className, ...props }) => (_jsxs(PaginationLink, { ...props, "aria-label": "Go to previous page", size: "default", className: cn('gap-1 pl-2.5', className), children: [_jsx(ChevronLeft, { className: "h-4 w-4" }), _jsx("span", { children: "Previous" })] }));
PaginationPrevious.displayName = 'PaginationPrevious';
const PaginationNext = ({ className, ...props }) => (_jsxs(PaginationLink, { ...props, "aria-label": "Go to next page", size: "default", className: cn('gap-1 pr-2.5', className), children: [_jsx("span", { children: "Next" }), _jsx(ChevronRight, { className: "h-4 w-4" })] }));
